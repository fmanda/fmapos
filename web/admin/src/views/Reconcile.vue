	...
	export default {
		data () {
			return {
				...
				items : [],
				fields : [
					{fieldname : 'transdate', caption : 'Tanggal', width: 120},
					{fieldname : 'unit_name', caption : 'Nama Unit', width: null},
					{fieldname : 'sales_amount', caption : 'Sales', width: 120},
					{fieldname : 'void_amount', caption : 'Void', width: 120},
					{fieldname : 'cash_in', caption : 'Kas Masuk', width: 120},
					{fieldname : 'cash_out', caption : 'Kas Keluar', width: 120},
					{fieldname : 'cash_amount', caption : 'Act Kas', width: 120},
					{fieldname : 'card_amount', caption : 'Act Kartu', width: 120}
				],
				error : {
					status : false,
					title : 'Error Occured',
		...
		methods:{
			refreshData(reset){
				...
				var url = CONFIG.rest_url + '/reconcileof/' + this.selectedCompany.id
						+ '/' + date1 + '/' + date2 + '/'
