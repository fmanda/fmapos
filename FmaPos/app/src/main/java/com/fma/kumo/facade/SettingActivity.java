...
import com.fma.kumo.facade.fragment.SelectPrinterFragment;
...
//    TextView txtCompanyPhone;
    ...
    private void registerAllView() {
        txtRestURL =(TextView) findViewById(R.id.txtRestURL);
...
//            txtCompanyPhone.setText(getSettingStr("company_phone"));
            ...
            txtRestURL.setText(getSettingStr("rest_url"));
...
//            setSetting("company_phone", txtCompanyPhone.getText().toString());
            setSetting("rest_url", txtRestURL.getText().toString());
